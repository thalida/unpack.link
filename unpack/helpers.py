...
class UnpackHelpers:
    ...
    EVENT_NAME = {
        'FETCH:NODE:QUEUED': 'FETCH:NODE:QUEUED',
        'FETCH:NODE:IN_PROGRESS': 'FETCH:NODE:IN_PROGRESS',
        'FETCH:NODE:COMPLETED': 'FETCH:NODE:COMPLETED',
        'STORE:LINK:COMPLETED': 'STORE:LINK:COMPLETED',
    }
