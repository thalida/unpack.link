<template>
    <div
      class="link"
      :class="[
        (direction === 'inbound') ? 'link--to-node' : 'link--from-node'
      ]">

      <span class="link__count">{{totalLinks}}</span>
  ...
  computed: {
    links () {
      if (this.direction === 'inbound') {
        return this.$store.getters.getLinksByTargetUUID(this.nodeUuid)
      } else if (this.direction === 'outbound') {
        return this.$store.getters.getLinksBySourceUUID(this.nodeUuid)
      }
    },
    totalLinks () {
